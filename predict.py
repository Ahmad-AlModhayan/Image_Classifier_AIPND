...
parser.add_argument("--gpu", type=bool, default=True, action="store_true", help='Should predict on gpu or no')
...
top_probs, top_labels, top_flowers = f_predict.predict(args.image_dir, model, cat_to_name, args.top_k)
